# Space Shooter Game - Kiro Project Structure

This directory contains all project specifications, design documents, implementation plans, and development guidelines for the Space Shooter Game.
...
2. **[requirements.md](specs/space-shooter-game/requirements.md)** - What the game should do
3. **[design.md](specs/space-shooter-game/design.md)** - How the game is built
4. **[tasks.md](specs/space-shooter-game/tasks.md)** - Implementation tasks
